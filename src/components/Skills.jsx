...
import { skills } from '../data'; // استدعاء البيانات

const Skills = () => {
  return (
    <section id="skills" className="py-20 w-full bg-slate-900/30">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-6">
          {skills.map((skill, index) => (
            <motion.div
              ...
              className="bg-primary border border-white/5 p-6 rounded-2xl flex flex-col items-center justify-center gap-4 transition-all group hover:shadow-xl hover:shadow-cyan-900/20"
            >
